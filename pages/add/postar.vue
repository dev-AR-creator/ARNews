...
<div class="flex flex-row justify-around w-screen h-auto min-h-screen  p-8 bg-[url('https://getwallpapers.com/wallpaper/full/b/a/7/74323.jpg')]">
  <div class="rounded-xl basis-1/2  shadow-2xl  p-8 m-16 bg-white ">
